...
static int ft8719_lcdnoise_test(bool *test_result)
{
    ...
    for (row = 0; row < tx_num + 1; ++row) {
        for (col = 0; col < rx_num; ++col) {
            lcdnoise[row * rx_num + col] = focal_abs_8719(lcdnoise[row * rx_num + col]);
        }
    }
...
static void init_basicthreshold_ft8719(char *ini)
{
    ...
    /* RawData Test */
    GetPrivateProfileString_8719("Basic_Threshold", "RawDataTest_Min", "5000", str, ini);
    ft8719_basic_thr.rawdata_test_min = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "RawDataTest_Max", "11000", str, ini);
    ft8719_basic_thr.rawdata_test_max = fts_atoi_8719(str);

    /* CB Test */
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_VA_Check", "1", str, ini);
    ft8719_basic_thr.cb_test_va_check = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_Min", "3", str, ini);
    ft8719_basic_thr.cb_test_min = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_Max", "60", str, ini);
    ft8719_basic_thr.cb_test_max = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_VKey_Check", "1", str, ini);
    ft8719_basic_thr.cb_test_vk_check = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_Min_Vkey", "3", str, ini);
    ft8719_basic_thr.cb_test_min_vk = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "CBTest_Max_Vkey", "100", str, ini);
    ft8719_basic_thr.cb_test_max_vk = fts_atoi_8719(str);

    /* Short Circuit Test */
    GetPrivateProfileString_8719("Basic_Threshold", "ShortCircuit_ResMin", "200", str, ini);
    ft8719_basic_thr.short_res_min = fts_atoi_8719(str);

    /* LCD Noise Test */
    GetPrivateProfileString_8719("Basic_Threshold", "LCD_NoiseTest_Frame", "50", str, ini);
    ft8719_basic_thr.lcd_noise_test_frame = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "LCD_NoiseTest_Max", "30", str, ini);
    ft8719_basic_thr.lcd_noise_test_max = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "LCD_NoiseTest_Coefficient", "50", str, ini);
    ft8719_basic_thr.lcd_noise_coefficient = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "LCD_NoiseTest_Coefficient_Key", "50", str, ini);
    ft8719_basic_thr.lcd_noise_coefficient_key = fts_atoi_8719(str);

    /* Open Test */
    GetPrivateProfileString_8719("Basic_Threshold", "OpenTest_CBMin", "64", str, ini);
    ft8719_basic_thr.open_test_cb_min = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "OpenTest_Check_K1", "0", str, ini);
    ft8719_basic_thr.open_test_k1_check = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "OpenTest_K1Threshold", "0", str, ini);
    ft8719_basic_thr.open_test_k1 = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "OpenTest_Check_K2", "0", str, ini);
    ft8719_basic_thr.open_test_k2_check = fts_atoi_8719(str);
    GetPrivateProfileString_8719("Basic_Threshold", "OpenTest_K2Threshold", "0", str, ini);
    ft8719_basic_thr.open_test_k2 = fts_atoi_8719(str);
...
static void init_testitem_ft8719(char *ini)
{
    ...
    /* RawData Test */
    GetPrivateProfileString_8719("TestItem", "RAWDATA_TEST", "1", str, ini);
    ft8719_item.rawdata_test = fts_atoi_8719(str);

    /* CB_TEST */
    GetPrivateProfileString_8719("TestItem", "CB_TEST", "1", str, ini);
    ft8719_item.cb_test = fts_atoi_8719(str);

    /* SHORT_CIRCUIT_TEST */
    GetPrivateProfileString_8719("TestItem", "SHORT_CIRCUIT_TEST", "0", str, ini);
    ft8719_item.short_test = fts_atoi_8719(str);

    /* LCD_NOISE_TEST */
    GetPrivateProfileString_8719("TestItem", "LCD_NOISE_TEST", "0", str, ini);
    ft8719_item.lcd_noise_test = fts_atoi_8719(str);

    /* OPEN_TEST */
    GetPrivateProfileString_8719("TestItem", "OPEN_TEST", "0", str, ini);
    ft8719_item.open_test = fts_atoi_8719(str);
...
static void init_detailthreshold_ft8719(char *ini)
{
    ...
    OnInit_InvalidNode_8719(ini);
    OnInit_DThreshold_RawDataTest_8719(ini);
    OnInit_DThreshold_CBTest_8719(ini);
