...
#define FTS_FW_VER_EXC_VAL                           0x9f
//#define FTXXXX_INI_FILEPATH_CONFIG                   "/sdcard/"
//#define FTXXXX_INI_FILEPATH_CONFIG                   "/system/etc/firmware/"  //Modify fw.bin from /sdcard to /system/etc/firmware/
#define FTXXXX_INI_FILEPATH_CONFIG                   "/system/vendor/firmware/"  //Modify fw.bin from /system/etc/firmware to /system/vendor/firmware/
